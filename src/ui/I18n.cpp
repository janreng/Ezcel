...
static const QHash<QString, QPair<QString, QString>> &table() {
    static const QHash<QString, QPair<QString, QString>> t = {
        ...
        // Cấu trúc
        {"st_ins_row",  {QStringLiteral("Chèn hàng bên trên"), QStringLiteral("Insert Row Above")}},
        {"st_ins_row_below", {QStringLiteral("Chèn hàng bên dưới"), QStringLiteral("Insert Row Below")}},
        {"st_ins_col",  {QStringLiteral("Chèn cột bên trái"),  QStringLiteral("Insert Column Left")}},
        {"st_ins_col_right", {QStringLiteral("Chèn cột bên phải"), QStringLiteral("Insert Column Right")}},
        ...
        {"hdr_insert_row", {QStringLiteral("Chèn hàng bên trên"), QStringLiteral("Insert Rows Above")}},
        {"hdr_insert_row_below", {QStringLiteral("Chèn hàng bên dưới"), QStringLiteral("Insert Rows Below")}},
        ...
        {"hdr_insert_col", {QStringLiteral("Chèn cột bên trái"), QStringLiteral("Insert Columns Left")}},
        {"hdr_insert_col_right", {QStringLiteral("Chèn cột bên phải"), QStringLiteral("Insert Columns Right")}},
