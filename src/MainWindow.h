...
private:
    ...
    void highlightTopBottom();                  // tô N ô lớn/nhỏ nhất (Spec 13)
    void highlightDuplicates();                 // tô ô giá trị trùng lặp (Spec 13)
    ...
    void solverDialog();                        // Bộ giải tối ưu (Solver, Spec 50)
