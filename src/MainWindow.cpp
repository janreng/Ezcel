...
void MainWindow::buildRibbon()
{
    ...
    m_ribbon->addSmallButton(QStringLiteral("cond_format"), QStringLiteral("Top/Bottom N"), [this] { highlightTopBottom(); });
    m_ribbon->addSmallButton(QStringLiteral("cond_format"), QStringLiteral("Giá trị trùng lặp"), [this] { highlightDuplicates(); });
